...
import UserManagementEliminarDialog from './user-management-delete-dialog';
...
const Routes = ({ match }) => (
  <>
    ...
    <ErrorBoundaryRoute path={`${match.url}/:login/delete`} component={UserManagementEliminarDialog} />
  </>
);
